...
import com.gb.billsharing.factory.ExpenseFactory;
...
public class ExpenseService {
    ...
    public void addExpense(ExpenseType expenseType, double amount, String paidBy, List<Split> splits, ExpenseMetadata expenseMetadata) {
        Expense expense = ExpenseFactory.createExpense(expenseType, amount, userMap.get(paidBy), splits, expenseMetadata);
